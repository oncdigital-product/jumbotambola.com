...
function loginCheck(){
    ...
    $.get("https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/sessionCheck.php",
...
function searchKey(key){
   ...
   url='https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/searchTicket.php';
    }else{
    url='https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/searchAgent.php'; 
    }
...
random6Btn.innerHTML=randomSheet[0][5];
    ...
    setTimeout(()=>{
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/shuffleTicket.php',
    {"jwt":localStorage.getItem("jwt")},
function(data){
...
function getFirstSixTicket(){
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getFirstSixTicket.php',
{"jwt":localStorage.getItem("jwt")},
function(data){
...
function sendPasswordToEmail(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/sendPasswordToEmail.php',
{"jwt":localStorage.getItem("jwt")},
function(data){
...
function getAnouncement(){
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getAnouncement.php',
    {"jwt":localStorage.getItem("jwt")},
    function(data){
...
function sendAnnouncement(){
  if(announceTa.value!=localStorage.getItem("announcement")){
    if(announceTa.value.length>0){
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/saveAnnouncement.php',
...
if(linkType==1){
 ...
 function login(){
         if(agentPassInp.value.length>0){
             loginBtnInp.value="...";
             $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/login.php',
...
function updateTheme(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/saveJsonFile.php',
...
function getGameSetting(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getJsonFile.php',
{"jwt":localStorage.getItem("jwt"),"jsonName":"gameSettingJSON"},
function(data){
///console.log(data);
...
function getGameStatus(){
    $.get('https://oncserver1.xyz/jumbotambola.com/api/gameApi/getGameStatus.php',
{"jwt":localStorage.getItem("jwt")},
function(data){
////console.log(data);
var json=JSON.parse(data);
...
function getBusinessInfo(){
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getBusinessInfo.php',
    {"jwt":localStorage.getItem("jwt")},
    function(data){
//console.log(data);
var json=JSON.parse(data);
...
function getDivident(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getDividentList.php',
...
function getSoldTicket(key,tableName){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getSoldTicket.php',
    {"jwt":localStorage.getItem("jwt"),"key":key},
    function(data){
 // //console.log(data);
...
//console.log(popWin1Status);
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getAgentList.php',
    {"jwt":localStorage.getItem("jwt")},
    function(data){
   // //console.log(data);
...
function getAllTicket(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getAllTicket.php',
    {"jwt":localStorage.getItem("jwt")},
    function(data){
   // //console.log(data);
...
function getRenewJson(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getRenewJson.php',
    {"jwt":localStorage.getItem("jwt")},
    function(data){
...
$.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getTicketDetail.php',
...
function editAgent(id){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getAgentDetail.php',
...
//------------now add to db
agentAddBtn.value="...";
$.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/addAgent.php',
...
if(edtAgentDateInp.value.length>0 || edtAgentNameInp.value.length>0 || edtAgentPhoneInp.value.length>0 || edtAgentPassInp.value.length>0 || edtAgentTotalTicketInp.value.length>0){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/saveAgent.php',
...
$.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/delAgent.php',
...
if(edtTNOdateInp.value.length>0 && edtTNOnameInp.value.length>0 && edtTNOphoneInp.value.length>0 && edtTNOagentInp.value.length>0){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/saveTNO.php',
    {"jwt":localStorage.getItem("jwt"),"json":JSON.stringify(json)},
    function(data){
    // //console.log(data);
    if(data=="success"){
    ...
    function resetTNO(){
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/resetTNO.php',
...
if(selectedTicket.length>0){
   if(bookerNameInp.value.length>0 && bookerPhoneInp.value.length>0){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/book.php',
...
s=0;
    ...
    function numCaller(){
       if((h+m+s)==0){
        $.get('https://oncserver1.xyz/jumbotambola.com/api/gameApi/generateWinTicket.php',
        {"jwt":localStorage.getItem("jwt")},
        function(data){
       // //console.log(data);
...
document.getElementById("block_num_"+calledNumArry[i]).style.background="yellow";
    ...
    function resetCallNum(){
       if(confirm("Are you sure you want reset called numbers?")){
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/resetCall.php',
        {"jwt":localStorage.getItem("jwt")},
        function(data){
console.log(data);
if(data=="success"){
...
setTimeout(function(){
    ...
    function resetTicket(){
        if(confirm("Are you sure you want reset entire tickets?")){
         ...
         $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/resetTicket.php',
         {"jwt":localStorage.getItem("jwt")},
         function(data){
 console.log(data);
 if(data=="success"){
 ...
 setTimeout(function(){
     ...
     function resetAgent(){
        if(confirm("Are you sure you want reset entire agents?")){
         resetAgentBtn.innerHTML="RESETTING...";
         $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/resetAgent.php',
         {"jwt":localStorage.getItem("jwt")},
         function(data){
 console.log(data);
 if(data=="success"){
 ...
 setTimeout(function(){
     ...
     function loadBackupTicket(){
        if(confirm("Are you sure you want load backup ticket?")){
         ...
         $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/addTicketBackup.php',
         {"jwt":localStorage.getItem("jwt")},
         function(data){
 console.log(data);
 if(data=="success"){
 ...
 setTimeout(function(){
     ...
     function showLastTicket(){
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/commonApi/getLastTicket.php',
        {"jwt":localStorage.getItem("jwt")},
        function(data){
//console.log(data);
...
showLastTicketBtn.innerHTML="SHOW PREVIOUS TICKET";
     ...
     function showLastWinner(){
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/commonApi/getLastWinner.php',
        {"jwt":localStorage.getItem("jwt")},
        function(data){
//console.log(data);
...
showLastWinnerBtn.innerHTML="SHOW PREVIOUS WINNER";
     ...
     function showLastNum(){
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/commonApi/getLastNumber.php',
        {"jwt":localStorage.getItem("jwt")},
        function(data){
console.log(data);
...
showLastNumBtn.innerHTML="SHOW PREVIOUS NUMBER";
     ...
     function showLastBusiness(){
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/commonApi/getLastBusiness.php?type=admin',
        {"jwt":localStorage.getItem("jwt")},
        function(data){
//console.log(data);
...
function showCurrentTicket(){
    renderTitleBtn.innerHTML="LAST CURRENT TICKET";
        ...
        $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getCurrentTicket.php',
        {"jwt":localStorage.getItem("jwt")},
        function(data){
//console.log(data);
...
function showCurrentWinner(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/Ui/adminUi/php/getCurrentWinner.php',
    {"jwt":localStorage.getItem("jwt")},
    function(data){
//console.log(data);
var currentTktList=JSON.parse(data);
...
function print(){
    ...
    window.location="https://oncserver1.xyz/jumbotambola.com/Ui/commonApi/printPdf.php?type="+printType+"&sender=admin";
}
