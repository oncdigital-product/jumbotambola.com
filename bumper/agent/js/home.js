...
$.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/sessionCheck.php',
...
function login(){
    if(agentNameInp.value.length>0){
        if(agentPassInp.value.length>0){
            loginBtnInp.value="...";
            $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/login.php',
...
function updateTheme(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/saveJsonFile.php',
...
function getGameSetting(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getJsonFile.php',
{"jwt":localStorage.getItem("agentJwt"),"jsonName":"gameSettingJSON"},
function(data){
//console.log(data);
...
function getBusinessInfo(){
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getBusinessInfo.php',
    {"jwt":localStorage.getItem("agentJwt")},
    function(data){
console.log(data);
var json=JSON.parse(data);
...
function getAgentInfo(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getAgentJson.php',
{"jwt":localStorage.getItem("agentJwt")},
function(data){
//console.log(data);
...
function getSoldTicket(key,tableName){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getSoldTicket.php',
...
console.log(popWin1Status);
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getAgentList.php',
    {"jwt":localStorage.getItem("agentJwt")},
    function(data){
   // console.log(data);
...
function getAllTicket(){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getAllTicket.php',
    {"jwt":localStorage.getItem("agentJwt")},
    function(data){
   // console.log(data);
...
$.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getTicketDetail.php',
...
function editAgent(id){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/getAgentDetail.php',
...
if(selectedTicket.length>0){
   if(bookerNameInp.value.length>0 && bookerPhoneInp.value.length>0){
    ...
    $.get('https://oncserver1.xyz/jumbotambola.com/bumper/Ui/agentUi/php/book.php',
